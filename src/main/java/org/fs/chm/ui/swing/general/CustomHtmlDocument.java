...
/**
 * Pretty much copy-pasted from {@link javax.swing.text.html.HTMLDocument} because the original was not extendable.
 */
...
public class CustomHtmlDocument extends HTMLDocument {
    ...
    public HTMLEditorKit.ParserCallback getReader(int pos) {
        ...
        HTMLReader reader = createHtmlReader(pos, 0, 0, null, true, false, true);
        return reader;
    }
    ...
    HTMLEditorKit.ParserCallback getReader(int pos, int popDepth,
        ...
        HTMLReader reader = createHtmlReader(pos, popDepth, pushDepth,
     ...
     */
    CustomMap getMap(String name) {
        if (name != null) {
            Object maps = getProperty(MAP_PROPERTY);

            if (maps != null && (maps instanceof Hashtable)) {
                return (CustomMap) ((Hashtable) maps).get(name);
            }
        }
        return null;
    }
    ...
    public void insertAfterEnd(Element elem, String htmlText) throws
        ...
        if (elem != null) {
            ...
            if (parent != null) {
                ...
                if (HTML.Tag.BODY.toString().equals(parent.getName())) {
                    insertInBody = true;
                }
                int offset = elem.getEndOffset();
    ...
    private void installParserIfNecessary() {
        if (getParser() == null) {
            throw new IllegalStateException("Expected parser to be set at this point!");
        }
    }
        ...
        if (parent != null && html != null) {
            ...
            if (parser != null) {
                ...
                if (charElement != null) {
                    ...
                    HTMLReader reader = createHtmlReader(offset, pop - 1, push,
                            null, false, true,
    ...
    protected HTMLReader createHtmlReader(int offset, int popDepth, int pushDepth,
                                          HTML.Tag insertTag, boolean insertInsertTag,
                                          boolean insertAfterImplied, boolean wantsTrailingNewline) {
        return new HTMLReader(offset, popDepth, pushDepth,
                insertTag, insertInsertTag, insertAfterImplied,
                wantsTrailingNewline);
    }
    ...
    public class HTMLReader extends HTMLEditorKit.ParserCallback {
        ...
        HTMLReader(int offset, int popDepth, int pushDepth,
            ...
            this.offset = offset;
            threshold = CustomHtmlDocument.this.getTokenThreshold();
            tagMap = new Hashtable<HTML.Tag, HTMLReader.TagAction>(57);
            HTMLReader.TagAction na = new HTMLReader.TagAction();
            HTMLReader.TagAction ba = new HTMLReader.BlockAction();
            HTMLReader.TagAction pa = new HTMLReader.ParagraphAction();
            HTMLReader.TagAction ca = new HTMLReader.CharacterAction();
            HTMLReader.TagAction sa = new HTMLReader.SpecialAction();
            HTMLReader.TagAction fa = new HTMLReader.FormAction();
            HTMLReader.TagAction ha = new HTMLReader.HiddenAction();
            HTMLReader.TagAction conv = new HTMLReader.ConvertAction();
            ...
            tagMap.put(HTML.Tag.ISINDEX, new HTMLReader.IsindexAction());
            ...
            tagMap.put(new HTML.UnknownTag("nobr"), ca);
            ...
            tagMap.put(HTML.Tag.PRE, new HTMLReader.PreAction());
            ...
            if (!emptyDocument && !midInsert) {
                ...
                Element elem =
                        CustomHtmlDocument.this.getCharacterElement(targetOffset);
                ...
                if (attrs != null) {
                    ...
                    if (tagToInsertInto != null) {
                        this.inParagraph = (
                                tagToInsertInto == HTML.Tag.P
                                        || tagToInsertInto == HTML.Tag.IMPLIED
                                        || tagToInsertInto == HTML.Tag.DT
                                        || tagToInsertInto == HTML.Tag.H1
                                        || tagToInsertInto == HTML.Tag.H2
                                        || tagToInsertInto == HTML.Tag.H3
                                        || tagToInsertInto == HTML.Tag.H4
                                        || tagToInsertInto == HTML.Tag.H5
                                        || tagToInsertInto == HTML.Tag.H6
                        );
                    }
                }
            }
        ...
        public void flush() throws BadLocationException {
            if (emptyDocument && !insertAfterImplied) {
                if (CustomHtmlDocument.this.getLength() > 0 ||
                        parseBuffer.size() > 0) {
                    flushBuffer(true);
                    adjustEndElement();
                }
        ...
        public void handleText(char[] data, int pos) {
            ...
            if (CustomHtmlDocument.this.getProperty(I18NProperty).equals(Boolean.FALSE)) {
                // if a default direction of right-to-left has been specified,
                // we want complex layout even if the text is all left to right.
                Object d = getProperty(TextAttribute.RUN_DIRECTION);
                if ((d != null) && (d.equals(TextAttribute.RUN_DIRECTION_RTL))) {
                    CustomHtmlDocument.this.putProperty(I18NProperty, Boolean.TRUE);
                } else {
                    if (isComplexLayout(data, 0, data.length)) {
                        CustomHtmlDocument.this.putProperty(I18NProperty, Boolean.TRUE);
                    }
                }
            }
        ...
        public void handleStartTag(HTML.Tag t, MutableAttributeSet a, int pos) {
            ...
            HTMLReader.TagAction action = tagMap.get(t);
        ...
        public void handleComment(char[] data, int pos) {
            ...
            HTMLReader.TagAction action = tagMap.get(HTML.Tag.COMMENT);
            if (action != null) {
         ...
         */
        public void registerTag(HTML.Tag t, HTMLReader.TagAction a) {
            tagMap.put(t, a);
        }
         ...
         */
        public class BlockAction extends HTMLReader.TagAction {
         ...
         */
        private class FormTagAction extends HTMLReader.BlockAction {
            public void start(HTML.Tag t, MutableAttributeSet attr) {
                super.start(t, attr);
         ...
         */
        public class ParagraphAction extends HTMLReader.BlockAction {
         ...
         */
        public class SpecialAction extends HTMLReader.TagAction {
         ...
         */
        public class IsindexAction extends HTMLReader.TagAction {
         ...
         */
        public class HiddenAction extends HTMLReader.TagAction {
         ...
         */
        class MetaAction extends HTMLReader.HiddenAction {
         ...
         */
        class HeadAction extends HTMLReader.BlockAction {
            ...
            private void handleLink(AttributeSet attr) {
                ...
                if (type.equals("text/css")) {
                    ...
                    String media = null; //(String) attr.getAttribute(HTML.Attribute.MEDIA);
                    if (media == null) {
                        media = "all";
                    } else {
         ...
         */
        class LinkAction extends HTMLReader.HiddenAction {
        ...
        class MapAction extends HTMLReader.TagAction {

            public void start(HTML.Tag t, MutableAttributeSet a) {
                lastMap = new CustomMap((String) a.getAttribute(HTML.Attribute.NAME));
                addMap(lastMap);
            }
        ...
        class AreaAction extends HTMLReader.TagAction {
        ...
        class StyleAction extends HTMLReader.TagAction {
         ...
         */
        public class PreAction extends HTMLReader.BlockAction {
         ...
         */
        public class CharacterAction extends HTMLReader.TagAction {
         ...
         */
        class ConvertAction extends HTMLReader.TagAction {
        ...
        class AnchorAction extends HTMLReader.CharacterAction {
        ...
        class TitleAction extends HTMLReader.HiddenAction {
        ...
        class BaseAction extends HTMLReader.TagAction {
        ...
        class ObjectAction extends HTMLReader.SpecialAction {
         ...
         * </table>
         */
        public class FormAction extends HTMLReader.SpecialAction {
            ...
            public void start(HTML.Tag t, MutableAttributeSet attr) {
                if (t == HTML.Tag.INPUT) {
                    ...
                    inTextArea = true;
                    textAreaDocument = new CustomTextAreaDocument();
                    ...
                    if ((size > 1) || multiple) {
                        CustomOptionListModel<CustomOption> m = new CustomOptionListModel<CustomOption>();
                        if (multiple) {
                            m.setSelectionMode(ListSelectionModel.MULTIPLE_INTERVAL_SELECTION);
                        }
                        selectModel = m;
                    } else {
                        selectModel = new CustomOptionComboBoxModel<CustomOption>();
                    }
                ...
                if (t == HTML.Tag.OPTION) {
                    option = new CustomOption(attr);

                    if (selectModel instanceof CustomOptionListModel) {
                        @SuppressWarnings("unchecked")
                        CustomOptionListModel<CustomOption> m = (CustomOptionListModel<CustomOption>) selectModel;
                        m.addElement(option);
                        if (option.isSelected()) {
                            m.addSelectionInterval(optionCount, optionCount);
                            m.setInitialSelection(optionCount);
                        }
                    } else if (selectModel instanceof CustomOptionComboBoxModel) {
                        @SuppressWarnings("unchecked")
                        CustomOptionComboBoxModel<CustomOption> m = (CustomOptionComboBoxModel<CustomOption>) selectModel;
                        m.addElement(option);
                        if (option.isSelected()) {
        ...
        void flushBuffer(boolean endOfStream) throws BadLocationException {
            int oldLength = CustomHtmlDocument.this.getLength();
            ...
            offset += CustomHtmlDocument.this.getLength() - oldLength;
            flushCount++;
        }
        ...
        CustomTextAreaDocument textAreaDocument = null;
        ...
        Hashtable<HTML.Tag, HTMLReader.TagAction> tagMap;
        int inBlock = 0;
    ...
    //
    // Stuff below is copied from sun.font.FontUtilities
    //
    ...
    public static boolean isComplexLayout(char[] chs, int start, int limit) {
